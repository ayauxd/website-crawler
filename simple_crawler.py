...
class SimpleCrawler:
    """A simple crawler for the Mac template website."""
...
async def main():
    # URL to crawl
    url = "https://mac-template.webflow.io/"
    
    # Create output directory
    output_dir = "./mac_template_output"
    
    # Create and run the crawler
    crawler = SimpleCrawler(url, output_dir)
    await crawler.run()
    
    print(f"\nCrawling completed! Output saved to {output_dir}")
